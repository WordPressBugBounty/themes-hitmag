...
* Added new hooks - hitmag_before_entry_header, hitmag_before_main_content.
...
= 1.3.6 =
* New: Added an option to enter the number of days to display popular posts on HitMag: Popular, Recent, Tags, Comments widget.
